...
#define INITIAL_WINDOW_PARAMS {0.360516,0.640559,1.33248e+08} // flower
//{0.360728,0.640144, 1.98057e+08} // flower'

// Color parameters backup
#define INITIAL_COLOR_PARAMS {0.71,0.32,0.29}
